...
**   4. Touch. Corresponds to actual mouse or touch screen hardware.
*/
...
public:
	 ...
	 * @param[in] withTouch Whether to update the touch states.
	 ...
	 *   Only returns valid "updateed" and "synced" data.
	 *
	...
	/**
	 * @brief Gets the current active mouse or touch states.
	 *
	 * @param[out] x
	 * @param[out] y
	 * @param[out] b0
	...
	/**
	 * @brief Gets the current active mouse or touch states in screen space.
	 *
	 * @param[out] x
	 * @param[out] y
	 * @param[out] b0
