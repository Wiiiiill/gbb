...
public:
	...
	/**
	 * @brief Gets the manually set palette, or created if `createIfNecessary` is `true`.
	 *
	 * @return The manually set palette, otherwise nullptr.
	 */
	virtual const Indexed::Ptr palette(bool createIfNecessary, bool assignNewCreated) = 0;
	/**
	 * @brief Sets the palette manually.
	 */
	...
	/**
	 * @brief Gets the palette color count if available.
	 */
	virtual int paletteCount(void) const = 0;
	/**
	 * @brief Gets the palette color if available.
	 */
	virtual Colour paletteAt(int index) const = 0;
	/**
	 * @brief Sets the palette color if available.
	 */
	virtual bool paletteAt(int index, const Colour &col) = 0;
