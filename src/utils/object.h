...
public:
	typedef std::pair<std::string, Variant> Argument;
	typedef std::initializer_list<Argument> Arguments;

public:
	GBBASIC_CLASS_TYPE('D', 'I', 'C', 'T')

	static Dictionary* create(void);
	static Dictionary* create(const Arguments &arguments);
