...
#define IS_FRAME_EVEN                            ((sys_time & 0x01) == 0)
#define IS_FRAME_ODD                             ((sys_time & 0x01) == 1)
#define IS_FRAME_2                               ((sys_time & 0x01) == 0)
#define IS_FRAME_4                               ((sys_time & 0x03) == 0)
#define IS_FRAME_8                               ((sys_time & 0x07) == 0)
#define IS_FRAME_16                              ((sys_time & 0x0F) == 0)
